...
public class JwtUtil {
	...
	public JwtUtil(@Value("${jwt.secret:VGhpc0lzQVN1cGVyU2VjdXJlS2V5Rm9ySldUVG9rZW5BdXRoZW50aWNhdGlvbg==}") String secretKey, GlobalExceptionHandler globalExceptionHandler) {
